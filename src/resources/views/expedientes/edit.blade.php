...
@section('page-title', 'Editar Expediente Clínico')

@section('content')
<div class="card max-w-4xl mx-auto" style="max-width: 900px;">
    <div class="card-header py-3 px-4 d-flex justify-content-between align-items-center">
        <h5 class="mb-0 fw-bold">Actualizar Datos - {{ $expediente->nombre_completo }}</h5>
        ...
        <form action="{{ route('expedientes.update', $expediente->id) }}" method="POST">
            ...
            <div class="row g-3 mb-4">
                <div class="col-md-6">
                    ...
                    <input type="text" name="nombre_completo" class="form-control @error('nombre_completo') is-invalid @enderror" value="{{ old('nombre_completo', $expediente->nombre_completo) }}" required maxlength="150">
                ...
                <div class="col-md-3">
                    ...
                    <input type="date" name="fecha_nacimiento" class="form-control @error('fecha_nacimiento') is-invalid @enderror" value="{{ old('fecha_nacimiento', $expediente->fecha_nacimiento->toDateString()) }}" required max="{{ now()->toDateString() }}">
                ...
                <div class="col-md-3">
                    ...
                    <select name="sexo" class="form-select @error('sexo') is-invalid @enderror" required>
                        ...
                        <option value="masculino" {{ old('sexo', $expediente->sexo) == 'masculino' ? 'selected' : '' }}>Masculino</option>
                        <option value="femenino" {{ old('sexo', $expediente->sexo) == 'femenino' ? 'selected' : '' }}>Femenino</option>
                        <option value="otro" {{ old('sexo', $expediente->sexo) == 'otro' ? 'selected' : '' }}>Otro</option>
                    </select>
                ...
                <div class="col-md-4">
                    ...
                    <select name="tipo_sangre" class="form-select @error('tipo_sangre') is-invalid @enderror">
                        ...
                        @foreach(['A+', 'A-', 'B+', 'B-', 'AB+', 'AB-', 'O+', 'O-'] as $ts)
                            <option value="{{ $ts }}" {{ old('tipo_sangre', $expediente->tipo_sangre) == $ts ? 'selected' : '' }}>{{ $ts }}</option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-4">
                    ...
                    <input type="tel" name="telefono" class="form-control @error('telefono') is-invalid @enderror" value="{{ old('telefono', $expediente->telefono) }}" maxlength="20">
                    @error('telefono') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>
                <div class="col-md-4">
                    <label class="form-label fw-bold">Correo Electrónico</label>
                    <input type="email" name="correo" class="form-control @error('correo') is-invalid @enderror" value="{{ old('correo', $expediente->correo) }}" maxlength="100">
            ...
            <div class="row g-3 mb-4">
                <div class="col-md-6">
                    ...
                    <textarea name="alergias" class="form-control @error('alergias') is-invalid @enderror" rows="2">{{ old('alergias', $expediente->alergias) }}</textarea>
                    @error('alergias') <div class="invalid-feedback">{{ $message }}</div> @enderror
                </div>
                <div class="col-md-6">
                    <label class="form-label fw-bold">Enfermedades Crónicas</label>
                    <textarea name="enfermedades_cronicas" class="form-control @error('enfermedades_cronicas') is-invalid @enderror" rows="2">{{ old('enfermedades_cronicas', $expediente->enfermedades_cronicas) }}</textarea>
                ...
                <div class="col-md-6">
                    ...
                    <textarea name="medicamentos_actuales" class="form-control @error('medicamentos_actuales') is-invalid @enderror" rows="2">{{ old('medicamentos_actuales', $expediente->medicamentos_actuales) }}</textarea>
                ...
                <div class="col-md-6">
                    ...
                    <textarea name="antecedentes_familiares" class="form-control @error('antecedentes_familiares') is-invalid @enderror" rows="2">{{ old('antecedentes_familiares', $expediente->antecedentes_familiares) }}</textarea>
