...
@section('content')
<div class="mb-4 mt-2">
    <h5 class="mb-0 fw-bold" style="font-family: 'Outfit', sans-serif;">Crear Nuevo Pedido</h5>
</div>
...
<div class="card border-0 shadow-sm" style="border-radius:12px;background:#fff;max-width:1000px;" id="pedidoFormApp">
...
<script>
    ...
    function addRow() {
        ...
        // Asignar IDs y names específicos si no usamos los dinámicos antes del submit
        // Para simplificar, configuraremos los name antes del submit
